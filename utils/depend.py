...
class ChromeBrowser:
    def __init__(self):
        ...
        # 设置UA
        chrome_options.add_argument('Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1')
        # 选择让谷歌模拟的设备
